...
const TEAM = [
  ...
  { initials: 'BD', name: 'Bezamariam Demeke', role: 'HR Manager', img: null, linkedin: 'https://www.linkedin.com/in/bezamariam-d/', blurb: 'Cultivating a high-performance culture and empowering the people who drive the vision.' },
  { initials: 'YM', name: 'Yismaw Mulaw', role: 'IT Admin / Cyber-Specialist', img: null, linkedin: 'https://www.linkedin.com/in/yismaw-mulaw-285016188/', blurb: 'Defending the digital frontier and ensuring the integrity of every byte.' },
  ...
  { initials: 'MH', name: 'Mikiyas Hailegebreal', role: 'Automation Engineer', img: null, linkedin: 'https://www.linkedin.com/in/mikiyas-hailegebreal-019487350', blurb: 'Automating the workflows and integrations that keep our delivery fast, consistent, and audit-ready.' },
  { initials: 'ST', name: 'Solomon Tadesse', role: 'Full Stack Developer', img: null, linkedin: 'https://www.linkedin.com/in/solomon-tadesse-fikre', blurb: 'Building and shipping the tools and platforms that power the Rem Assist experience end to end.' },
  { initials: 'EL', name: 'Ermias Lemma', role: 'BDR Lead', img: null, linkedin: 'https://www.linkedin.com/in/ermias-lemma-4a9a65376', blurb: 'Turning outreach and discovery into measurable pipeline growth and qualified meetings.' },
];
